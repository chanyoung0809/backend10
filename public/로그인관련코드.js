...
/* https://www.passportjs.org/ 회원가입 라이브러리
    Documentation <= 공식 사용설명서
    How to Guides -> Username & Password -> 로그인은 post 방식.
      app.post('/login/password', passport.authenticate('local', {
        successRedirect: '/',
        failureRedirect: '/login'
      }));

    Strategies:검증 방법, 전략... -> passport-local -> Usage <= 공식 사용설명서
*/
...
// 여기 있는 passport 가 위에서 설정한 passport
